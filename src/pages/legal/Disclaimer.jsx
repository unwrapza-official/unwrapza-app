  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto px-4 py-12 text-gray-800">
      ...
      <p className="mb-4">
        ...
        Unwrapza may earn a commission at <strong>no additional cost to you</strong>.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">How affiliate links work</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">No influence on product ranking</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">Price and availability</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">No extra cost to users</h2>
      <p className="mb-4">
