const TermsConditions = () => {
  return (
    <div className="w-full max-w-[1200px] mx-auto px-4 py-12 text-gray-800">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">3. External Retailers</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">4. Product Information Accuracy</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">5. Affiliate Links</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">6. Privacy & Cookies</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        If you have questions, contact us at <strong>info@unwrapza.com</strong>.
      </p>
    </div>
  );
};
