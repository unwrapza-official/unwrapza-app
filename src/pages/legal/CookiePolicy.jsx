const CookiePolicy = () => {
  return (
    <div className="w-full max-w-[1200px] mx-auto px-4 py-12 text-gray-800">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">2. Cookies We Use</h2>

      <h3 className="font-semibold mb-1">2.1 Functional Cookies</h3>
      <p className="mb-4">
      ...
      <h3 className="font-semibold mb-1">2.2 Analytics Cookies (Anonymous)</h3>
      <p className="mb-4">
      ...
      <h3 className="font-semibold mb-1">2.3 Affiliate Tracking Cookies</h3>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">4. You Have Control Over Cookies</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">5. No Advertising or Personal Tracking</h2>
      <p className="mb-4">
      ...
      <h2 className="text-xl font-semibold mt-6 mb-2">6. Changes to This Cookie Policy</h2>
      <p className="mb-4">
      ...
      <p>
        ...
        <strong>info@unwrapza.com</strong>.
      </p>
    </div>
  );
};
